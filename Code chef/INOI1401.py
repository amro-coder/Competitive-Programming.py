...
for i in range(r-1,-1,-1):
    for j in range(c-1,-1,-1):
        ...
        for moves in range(1,d+1):
            dp[i][j][0][moves]=(dp[i][j+1][0][moves-1]%20011+dp[i][j+1][1][d]%20011)%20011
            dp[i][j][1][moves]=(dp[i+1][j][0][d]%20011+dp[i+1][j][1][moves-1]%20011)%20011
print((dp[0][0][0][d]+dp[0][0][1][d])%20011)